...
class DetectionTab:
    ...
    def __init__(self, parent, app):
        ...
        # Instructions
        instructions_frame = ttk.LabelFrame(self.settings_frame, text="Instructions")
        instructions_frame.pack(fill=X, padx=10, pady=5, expand=False)
        ...
        - Spaces must be defined in Setup tab

        For vehicle counting:
        - Adjust line height for counting position
        - Use ML detection for best results
        """
